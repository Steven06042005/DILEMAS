...
4. El QR de `session.html` usa automáticamente la URL pública actual. En GitHub Pages debería apuntar a `https://Steven06042005.github.io/DILEMAS/student.html?room=ABC123`.
